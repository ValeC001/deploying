...
<form action="" id="FormEditPersonal">
  <div class="modal-body row">
    ...
    <div class="form-group col-md-6">
      <label for="">C.I.</label>
      <input type="number" class="form-control" id="ciPersonal" name="ciPersonal" value="<?php echo $personal['ci_personal']; ?>">
    </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="telPersonal" name="telPersonal" value="<?php echo $personal['telefono']; ?>">
    </div>
