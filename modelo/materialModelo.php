...
class ModeloMaterial{
  ...
  static public function mdlRegMaterial($data){
    ...
    $stmt=Conexion::conectar()->prepare("insert into material(cod_material, desc_material, unidad, valor_unidad, costo_material, img_material)values('$codMaterial', '$nomMaterial', '$medidaMaterial', '$precioMaterial', '$costoMaterial' , '$imgMaterial')");
  ...
  static public function mdlInfoMaterial($id){
    $stmt=Conexion::conectar()->prepare("select * from material where id_material=$id");
    $stmt->execute();
  ...
  static public function mdlEditMaterial($data){
    ...
    $stmt=Conexion::conectar()->prepare("update material set cod_material='$codMaterial', desc_material='$nomMaterial', unidad='$medidaMaterial', costo_material='$costoMaterial', valor_unidad='$precioMaterial', img_material='$ImgMaterial', estado_material='$estadoMaterial' where id_material=$idMaterial");
